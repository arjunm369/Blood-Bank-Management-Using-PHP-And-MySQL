...
$sid = $_SESSION['id'];
$data10 = getRow($con, "SELECT * FROM tbl_admin WHERE admin_id=?", "s", array($sid));
...
<head>
  ...
  <title>DROPE OF HOPE- Admin</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="admin_participants.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="admin_participants.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="admin_faq.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="admin_ambulance.php">
          <i class="bi bi-envelope"></i>
          <span>Ambulance</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="admin_feedback.php">
          <i class="bi bi-envelope"></i>
          <span>Feedback</span>
        </a>
      </li>
